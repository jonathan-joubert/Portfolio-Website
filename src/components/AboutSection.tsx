...
export function AboutSection() {
  const skills = [
    "React", "TypeScript", "Node.js", "Python", "Linux", "Docker",
    "PostgreSQL", "MongoDB", "Git", "AWS", "Bash", "Express.js"
  ];
  ...
  const expertise = [
    ...
    },
    {
      ...
      description: "Implementing CI/CD pipelines and security best practices"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A passionate developer who loves to explore new technologies and solve complex problems
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              My passion for technology started early, and I've been fascinated by the power 
              of Linux and open-source software ever since. Over the years, I've honed my 
              skills in full-stack development while maintaining a deep love for system 
