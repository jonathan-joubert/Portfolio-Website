  ...
  return (
    <>
      ...
      <Button
        ...
        className={`fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-primary transition-all duration-300 ${
      ...
      {/* Chat window */}
      {isOpen && (
        <Card className={`fixed bottom-6 right-6 w-80 h-96 flex flex-col shadow-card transition-all duration-300 ${
